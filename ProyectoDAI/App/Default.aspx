...
<asp:Content ID="Default" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        ...
        <p><a href="/App/Informe" class="btn btn-primary btn-lg">Explorar el informe &raquo;</a></p> 
    </div>
    <div class="jumbotron">
        ...
        <p><a href="/App/Seguimiento" class="btn btn-primary btn-lg">Vamos a hacer ejercicio &raquo;</a></p> 
    </div>
    <div class="jumbotron">
        ...
        <p><a href="/App/Control" class="btn btn-primary btn-lg">Gestiona tus Chequeos &raquo;</a></p> 
    </div>
    <div class="jumbotron">
        <h1>Medicamentos</h1>
        ...
        <p><a href="/App/Medicamentos" class="btn btn-primary btn-lg">Administra tus Medicamentos &raquo;</a></p> 
    </div>
    <div class="jumbotron">
        ...
        <p><a href="/App/Foro" class="btn btn-primary btn-lg">Únete al Foro &raquo;</a></p> 
    </div>
</asp:Content>