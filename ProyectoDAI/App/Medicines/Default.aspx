...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="tblMedicines" runat="server"></asp:Table>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <asp:DropDownList ID="ddlMedicines" CssClass="form-control" runat="server" required ValidationGroup="AddMedicine"></asp:DropDownList>
            <asp:TextBox ID="txbQuantity" TextMode="Number" CssClass="form-control" placeholder="Cantidad" runat="server" required ValidationGroup="AddMedicine"></asp:TextBox>
            <br />
        ...
        <div class="col-md-6">
            ...
            <asp:TextBox ID="txbNewMedicine" CssClass="form-control" placeholder="Nombre del medicamento" runat="server" required ValidationGroup="NewMedicine"></asp:TextBox>
            <asp:TextBox ID="txbNewQuantity" TextMode="Number" CssClass="form-control" placeholder="Cantidad" runat="server" required ValidationGroup="NewMedicine"></asp:TextBox>
            <br />
            <div class="error-message-container">
